...
from db import DBBaseDM, BgpRouterDM, PhysicalRouterDM, PhysicalInterfaceDM,\
    ...
    RoutingProtocolsDM, FabricInterfaceDM
...
class DeviceManager(object):
    _REACTION_MAP = {
        ...
        'fabric_interface': {
            ...
            'physical_router': ['logical_interface'],
            'logical_interface': ['physical_router'],
            'fabric_interface': ['physical_router'],
        },
        'logical_interface': {
            'self': ['physical_router',
                     'physical_interface',
        ...
        'routing_protocols': {
            'self': ['physical_router'],
            'routing_protocols': ['physical_router'],
            'physical_router': [],
        },
    }
    ...
    def __init__(self, args=None):
        ...
        for obj in RoutingProtocolsDM.list_obj():
            RoutingProtocolsDM.locate(obj['uuid'],obj)

        for obj in FabricInterfaceDM.list_obj():
            fi = FabricInterfaceDM.locate(obj['uuid'],obj)
            if fi:
